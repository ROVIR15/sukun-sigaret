...
class bk_googlebadge extends WP_Widget {
	...
	function widget($args, $instance)
	{
		...
		<script type="text/javascript" src="https://apis.google.com/js/plusone.js"></script>
            <div id="gplus-badge" class="g-person" data-href="https://plus.google.com/<?php echo esc_attr($gg_profileid);?>" data-layout="<?php echo $layout;?>" data-showcoverphoto="<?php echo $showcoverphoto;?>" data-theme="<?php echo $theme;?>" data-width=360></div>
		<?php 
			echo $after_widget;
	...
	function form($instance)
	{
		...
		<p>
			...
			<input type="text" id="<?php echo $this->get_field_id('gg_profileid'); ?>" name="<?php echo $this->get_field_name('gg_profileid'); ?>" value="<?php echo esc_attr($instance['gg_profileid']); ?>" style="width:100%;" />
		</p>
