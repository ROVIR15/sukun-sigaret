...
class bk_flickr extends WP_Widget {
	...
	function bk_flickr() {
		...
		/* Create the widget. */
		$this->WP_Widget('bk_flickr', __('BK-Ninja: Widget Flickr', 'bkninja'), $widget_ops);
	}
		...
		<ul class="flickr clearfix" id="flickr-<?php echo $uid;?>"></ul>
            <script type="text/javascript">
				jQuery(document).ready(function($){
					$.getJSON("http://api.flickr.com/services/feeds/photos_public.gne?ids=<?php print esc_attr($flickr_id); ?>&lang=en-us&format=json&jsoncallback=?", function(data){
	...
	?>
            ...
            <input class="widefat" id="<?php echo $this->get_field_id('flickr_id'); ?>" name="<?php echo $this->get_field_name('flickr_id'); ?>" type="text" value="<?php echo esc_attr($instance['flickr_id']); ?>" /></label></p>
			
			<p><label for="<?php echo $this->get_field_id('flickr_counter'); ?>"><strong><?php _e('Number of images:', 'bkninja') ?></strong>
            <input class="widefat" id="<?php echo $this->get_field_id('flickr_counter'); ?>" name="<?php echo $this->get_field_name('flickr_counter'); ?>" type="text" value="<?php echo esc_attr($instance['flickr_counter']); ?>" /></label></p>
<?php
	}
}