...
class bk_top_review extends WP_Widget {
	 ...
	 * Widget setup.
	 */
	function bk_top_review() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'widget-top-review', 'description' => __('[Sidebar widget] Displays top review posts in sidebar.', 'bkninja') );

		/* Create the widget. */
		$this->WP_Widget( 'bk_top_review', __('BK-Ninja: Widget Top Reviews', 'bkninja'), $widget_ops);
	}
...
?>      
	...
	function form( $instance ) {
		$defaults = array('title' => 'Latest Reviews', 'entries_display' => 5, 'top-reviews' => 'all-time', 'category' => 'all');
    ...
    <p>
        ...
        <input type="text" id="<?php echo $this->get_field_id('entries_display'); ?>" name="<?php echo $this->get_field_name('entries_display'); ?>" value="<?php echo esc_attr($instance['entries_display']); ?>" style="width:100%;" />
    </p>        
