  ...
  $=jQuery;
    ...
    //                    console.log(module_settings.title);                                                                                                    
    		...
    		module_append: function( module_type, blk_order, insection ) {
                ...
                if (($new_module.find( '.bk-module-type' ).val() == 'row_wbg') || ($new_module.find( '.bk-module-type' ).val() == '1l_list_side')
                    || ($new_module.find( '.bk-module-type' ).val() == 'most_commented') || ($new_module.find( '.bk-module-type' ).val() == 'latest')
                ) {
                ...
                if (($new_module.find( '.bk-module-type' ).val() == 'custom_html') || ($new_module.find( '.bk-module-type' ).val() == 'adsense')) {
