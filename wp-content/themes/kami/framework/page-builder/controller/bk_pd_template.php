	...
	function bk_page_builder_temp() {
		...
		<div id="bk-container">
			...
			<div class="bk-sections">
				<div class="bk-section-empty"><?php _e( 'Choose <strong>Layout section</strong> to add new section.', 'bkninja') ?></div>
				<div class="bk-section-loading"><?php _e( 'Loading ...', 'bkninja' ) ?></div>
			</div>
			...
			<script id="bk-sidebar-template" type="text/template">
                <div class='sidebar'><label>Choose a sidebar</label>
    				<select class = 'bk-sidebar-order'>
    					<option value="0"><?php echo __( 'None', 'bkninja' ); ?></option>
                ...
                <div class="bk-section fullwidth">
                    ...
                    <div class='bk-modules-wrap'>
            			...
            			<div class="bk-modules">
            				...
            				<div class="bk-section-empty"><?php _e( 'Click <strong>Add Module</strong> button to add new module.', 'bkninja' ) ?></div>
            				<div class="bk-section-loading"><?php _e( 'Loading ...', 'bkninja' ) ?></div>
            			</div>
                    </div>
                </div>
                    ...
                    <div class='bk-modules-wrap'>
                        ...
                        <div class="leftsec">
                			...
                			<div class="bk-modules leftsec_placeholder">
                                <input type="hidden" class="bk-section-type">
                				<div class="bk-section-empty"><?php _e( 'Click <strong>Add Module</strong> button to add new section.', 'bkninja' ) ?></div>
                				<div class="bk-section-loading"><?php _e( 'Loading ...', 'bkninja' ) ?></div>
                			</div>
                        ...
                        <div class="rightsec">
                			...
                			<div class="bk-modules rightsec_placeholder">
                                <input type="hidden" class="bk-section-type">
                				<div class="bk-section-empty"><?php _e( 'Click <strong>Add Module</strong> button to add new module.', 'bkninja' ) ?></div>
                				<div class="bk-section-loading"><i class="icon-entypo-arrows-ccw"></i> <?php _e( 'Loading ...', 'bkninja' ) ?></div>
                			</div>
