...
if ( ! function_exists( 'bk_mainslider' ) ) {
	function bk_mainslider( $page_id, $module_prefix, $the_query ) {?>
        ...
        <?php if ( $the_query->have_posts() ) :?>
                <div id="<?php echo $mainslider_id;?>" class="slider-wrap flexslider">
                    <ul class="slides">
                        <?php while ( $the_query->have_posts() ): $the_query->the_post(); ?>	
                        <?php $thumb = wp_get_attachment_image_src( get_post_thumbnail_id(get_the_ID()), 'bkmain_slider');?>
                            <li class="item">
                                <div class="slider-background" style="background-image:url(<?php echo $thumb['0'];?>);background-size:cover;background-position:50% 50%;background-repeat:no-repeat;"></div>
                ...
                <!-- rewind -->
                <?php rewind_posts(); ?>
                <div id="<?php echo $carousel_ctr_id;?>" class="carousel-ctrl flexslider">
