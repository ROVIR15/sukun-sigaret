            ...
            if ($object->object == "category") {   
                ...
                foreach ( $bk_qry_latest->posts as $bk_post ) {
                    ...
                    if(has_post_thumbnail( $bk_post_id )) {
                        $bk_img = get_the_post_thumbnail($bk_post_id, 'bk400_300');
                    }else {
                        $bk_img =  '<img width="400" height="300" src="'.get_template_directory_uri().'/images/bkdefault400_300.jpg">';
                    }
                    ...
                    $bk_post_icon = bk_get_post_icon($bk_post_id);
        ...
        <li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes ); ?>">
            <dl class="menu-item-bar">
                <dt class="menu-item-handle">
                    <span class="item-title"><span class="menu-item-title"><?php echo esc_html( $title ); ?></span> <span class="is-submenu" <?php echo esc_attr($submenu_text); ?>><?php _e( 'sub item' , 'bkninja'); ?></span></span>
