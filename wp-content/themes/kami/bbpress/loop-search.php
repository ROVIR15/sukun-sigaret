...
<ul id="bbp-search-results" class="forums bbp-search-results">
	...
	<li class="bbp-header">
		...
		<div class="bbp-search-author bk-forum-header-font"><?php  _e( 'Author',  'bbpress' ); ?></div><!-- .bbp-reply-author -->

		<div class="bbp-search-content bk-forum-header-font">
	...
	<li class="bbp-footer bk-bbp-footer">

		<div class="bbp-search-author bk-forum-header-font"><?php  _e( 'Author',  'bbpress' ); ?></div>
